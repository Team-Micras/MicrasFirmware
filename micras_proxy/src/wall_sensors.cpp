...
template <uint8_t num_of_sensors>
void WallSensors<num_of_sensors>::turn_off() {
    this->led_0_pwm.set_duty_cycle(0.0F);
    this->led_1_pwm.set_duty_cycle(0.0F);
}

template <uint8_t num_of_sensors>
void WallSensors<num_of_sensors>::update() {
...
template <uint8_t num_of_sensors>
core::Observation WallSensors<num_of_sensors>::get_observation(uint8_t sensor_index) const {
